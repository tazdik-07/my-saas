...
const benefits = [
    { text: "Find qualified doctors near you", icon: CheckIcon },
    { text: "Book appointments instantly", icon: CheckIcon },
    { text: "Access medical records online", icon: CheckIcon },
    { text: "24/7 emergency support available", icon: CheckIcon },
]
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-7xl text-center animate-fade-in">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300 max-w-3xl mx-auto sm:text-base">
            Book the right doctor faster with verified reviews, real-time availability, and a smooth, no-wait experience from start to finish.
          </p>
        </div>
