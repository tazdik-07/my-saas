    ...
    <section className="py-20 bg-[#0b1220] text-white">
      <div className="container mx-auto px-6 text-center max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="flex flex-col items-center bg-[#1c2434] p-6 rounded-xl shadow-lg card-hover">
            <div className="bg-[#0c1322] p-4 rounded-2xl mb-4">
          ...
          <div className="flex flex-col items-center bg-[#1c2434] p-6 rounded-xl shadow-lg card-hover">
            <div className="bg-[#0c1322] p-4 rounded-2xl mb-4">
              <ListChecks className="w-8 h-8 text-[#02c39a]" />
            </div>
          ...
          <div className="flex flex-col items-center bg-[#1c2434] p-6 rounded-xl shadow-lg card-hover">
            <div className="bg-[#0c1322] p-4 rounded-2xl mb-4">
              <FileText className="w-8 h-8 text-[#02c39a]" />
            </div>
